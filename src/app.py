...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn and practice tennis skills with recreational play",
    ...
    "Art Studio": {
        ...
        "schedule": "Tuesdays, Thursdays, Saturdays, 2:00 PM - 4:00 PM",
        "max_participants": 18,
    ...
    "Science Research Lab": {
        "description": "Conduct experiments and participate in hands-on scientific research",
